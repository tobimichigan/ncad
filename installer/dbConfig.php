...
<?php } ?>
        ...
        unsure of what to fill in, I suggest that you use the default values.</p>
...
<tr>
	...
	<td class="tdValues"><input type="text" name="dbName" value="<?php echo  isset($_SESSION['dbInfo']['dbName']) ? $_SESSION['dbInfo']['dbName'] : 'nonacademic.hrm_db'?>" tabindex="3"></td>
</tr>
...
<tr>
	...
	<td class="tdValues"><input type="text" name="dbUserName" value="<?php echo  isset($_SESSION['dbInfo']['dbUserName']) ? $_SESSION['dbInfo']['dbUserName'] : 'root'?>" tabindex="4"> <strong style="color:#F00">*</strong></td>
</tr>
<tr>
	<td class="tdComponent">Privileged Database User Password</td>
	<td class="tdValues"><input type="password" name="dbPassword" value="<?php echo  isset($_SESSION['dbInfo']['dbPassword']) ? $_SESSION['dbInfo']['dbPassword'] : ''?>" tabindex="5" > <strong style="color:#F00">*</strong></td>
</tr>
<tr>
	<td class="tdComponent">Use the same Database User for LASUHRM</td>
...
<?php  } ?>
<tr>
	<td class="tdComponent">LASUHRM Database Username</td>
	<td class="tdValues"><input type="text" name="dbOHRMUserName" <?php echo isset($_POST['chkSameUser']) ? 'disabled' : '' ?> value="<?php echo  isset($_SESSION['dbInfo']['dbOHRMUserName']) ? $_SESSION['dbInfo']['dbOHRMUserName'] : 'lasuhrm'?>" tabindex="7"> #</td>
</tr>
<tr>
	<td class="tdComponent">LASUHRM Database User Password</td>
...
<div id="pDescription">
<font size="1"><strong style="color:#F00">*</strong> Privileged Database User should have the rights to create databases, create tables, insert data into table, alter table structure and to create database users.</font>
</div>
<div id="oDescription">
<font size="1"># LASUHRM database user should have the rights to insert data into table, update data in a table, delete data in a table.</font>
</div>
